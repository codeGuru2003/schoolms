                    ...
                    <div class="row">
                      ...
                      <div class="col-xxl-4 col-md-6">
                        <div class="card info-card sales-card">
                          <div class="card-body">
                            <h5 class="card-title">Fees Collected <span>| This Month</span></h5>
                      ...
                      <div class="col-xxl-4 col-md-6">
                        <div class="card info-card revenue-card">
                          <div class="card-body">
                            <h5 class="card-title">Expected Fees <span>| This Month</span></h5>
                      ...
                      <div class="col-12">
                        <div class="card">
                          <div class="card-body">
                            <h5 class="card-title">Total No. of Students Per Class <span>| This Year</span></h5>
                      ...
                      <div class="col-12">
                        <div class="card recent-sales overflow-auto">
                          <div class="card-body">
                            <h5 class="card-title">Recent Payments <span>| This Month</span></h5>
