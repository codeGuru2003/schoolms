...
@section('content')
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">Create Faculty Member</div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group mb-2">
                                <label for="userImage" class="form-label">Faculty Image</label>
                                <input type="file" name="userImage" id="userImage" accept=".png,.jpg,.gif" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group mb-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group mb-2">
                                ...
                                <input type="date" name="year_of_employment" id="year_of_employment" required class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group mb-2">
                                <label for="qualifications" class="form-label">Qualifications</label>
                                <input type="text" name="qualifications" id="qualifications" required class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group mb-2">
                                ...
                                <select name="marital_status_id" id="marital_status_id" required class="form-control">
                                    <option value="0">Select Marital Status</option>
                                    @foreach($maritalstatuses as $maritalStatusId => $maritalStatusName)
                                        <option value="{{ $maritalStatusId }}">{{ $maritalStatusName }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
